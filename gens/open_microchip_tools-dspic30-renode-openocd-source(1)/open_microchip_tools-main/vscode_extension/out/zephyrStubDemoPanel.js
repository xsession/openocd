...
exports.showZephyrStubDemoPanel = showZephyrStubDemoPanel;
const vscode = __importStar(require("vscode"));
const settings_1 = require("./settings");
const utils_1 = require("./utils");
function renderZephyrStubDemoHtml(initialValues) {
...
async function showZephyrStubDemoPanel(backend, refreshViews) {
    const initialValues = (0, settings_1.loadZephyrStubDemoDefaults)();
    const panel = vscode.window.createWebviewPanel('openMicrochipTools.zephyrStubDemo', 'Open Microchip Tools: Zephyr Stub Demo', vscode.ViewColumn.Active, { enableFindWidget: false, enableScripts: true });
    panel.webview.html = renderZephyrStubDemoHtml(initialValues);
    panel.webview.onDidReceiveMessage(async (message) => {
        if (message.command === 'saveZephyrStubDefaults') {
            await (0, settings_1.persistZephyrStubDemoDefaults)({
        ...
        try {
            ...
            void panel.webview.postMessage({ command: 'demoCompleted', summary, resultText: (0, utils_1.stringify)(runResult) });
...
//# sourceMappingURL=zephyrStubDemoPanel.js.map