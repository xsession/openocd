...
import { RenodeBackend } from './backends/renodeBackend';
...
class C2000DebugAdapter {
  ...
  private normalizeConfig(input: any, request: 'launch' | 'attach'): LaunchConfig {
    ...
    return {
      ...
      renodePath: substitute(input.renodePath),
      renodeScript: substitute(input.renodeScript),
