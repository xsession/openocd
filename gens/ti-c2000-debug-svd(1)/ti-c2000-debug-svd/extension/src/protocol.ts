...
export type BackendKind = 'ccs' | 'openocd' | 'renode' | 'mock';
...
export interface LaunchConfig {
  ...
  renodeScript?: string;
  renodeHost?: string;
  renodeMonitorPort?: number;
  renodeLaunch?: boolean;
  renodeArgs?: string[];
  renodeCpu?: string;
  renodeSysbus?: string;
  renodeMachine?: string;
  renodeStartupTimeoutMs?: number;
  renodeStopPollIntervalMs?: number;
  renodeLoadExecutable?: boolean;
  renodeBinaryLoadAddress?: string | number;
  renodeEntryAddress?: string | number;
  renodeResetCommand?: string;
