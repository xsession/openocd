...
```console
$ LINUX_CONFIGURE_FLAGS="..." docker compose -f docker/compose.yaml build linux-amd64
$ WINDOWS_CONFIGURE_FLAGS="..." docker compose -f docker/compose.yaml build windows-x86_64
```
